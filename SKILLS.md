...
## Purpose
This skill runs the agent against a customer identifier, uses the MCP-backed customer context, evaluates the generated response against expected facts, and writes an HTML report with a PASS/REVIEW verdict.

## Files
- [skills/agent_eval/run_agent_eval.py](skills/agent_eval/run_agent_eval.py) — main skill entry point
- [skills/agent_eval/__init__.py](skills/agent_eval/__init__.py) — package marker
...
```bash
.\.venv\Scripts\python.exe skills/agent_eval/run_agent_eval.py
```
